        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            if (granted) {
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Camera Permission Denied", @"camera permission denied title")
                                                                message:NSLocalizedString(@"This app does not have permission to use the camera; please update your settings.", @"camera permission denied recovery suggestion")
                                                               delegate:self
...
-(void) rightButtonPressedOnToolbar:(CameraToolBar *)toolbar {
    NSLog(@"Photo libaray button pressed.");
}
