...
-(instancetype) initWithImageNames:(NSArray *)imageNames {
    ...
    if (self) {
        ...
        self.purpleView.backgroundColor = [UIColor colorWithRed:0.345 green:0.318 blue:0.423 alpha:1];
...
-(void) layoutSubviews {
    ...
    self.purpleView.frame = CGRectMake(buttonWidth, 0, buttonWidth, CGRectGetHeight(whiteFrame));
