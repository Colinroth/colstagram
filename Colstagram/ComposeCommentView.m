...
- (NSAttributedString *) commentAttributedString {
    ...
    [commentString addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithRed:0.933 green:0.933 blue:0.993 alpha:1] range:range];
...
-(void) commentButtonPressed: (UIButton *) sender {
    if (self.isWritingComment) {
        ...
        [self.delegate commentViewDidPressButton:self];
    } else {
